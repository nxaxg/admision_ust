<?php
    /*
    Template Name: Página Charlas a colegios
    */
    ...
    if( isset( $_POST['st_nonce'] ) ){
        $sending_form_valid = send_charlas_form( $_POST );
    }
                ...
                <div class="grid-9 grid-smalltablet-12 no-gutter-right no-gutter-smalltablet">
                    ...
                    <?php
                        if( $sending_form_valid === false ) :
                            ...
                            if( $contenido_principal === 'tipos_de_charla' ) {
                                $charlas_active = 'active';
                        ...
                        <div class="tabs-holder">
                            <div class="tabs-controls">
                                <?php if( empty($charlas) ) : ?>
                                    <button class="<?php echo $charlas_active; ?>" title="Ver pestaña" data-func="tabControl" data-target="informacion">Tipos de charlas</button>
                                <?php endif; ?>
                            ...
                            <div class="tabs-box">
                                <div class="tab-item <?php echo $charlas_active; ?>" data-tab-name="informacion" >
                                    <div class="white-section">
                                        <?php
                                            $groups = (array)get_field('agrupaciones');

                                            foreach( $groups as $group ):
                                        ?>
                                        <div class="downloads-box">
                                            <h4 class="downloads-box-header"><?php echo $group['titulo']; ?></h4>
                                            <div class="downloads-box-body">
                                                <ul class="regular-ul">
                                                    <?php
                                                        foreach( $group['archivos'] as $file ){
                                                            echo '<li><a href="'. $file['archivo']['url'] .'" title="Descargar archivo" target="_blank" download>'. $file['nombre'] .'</a></li>';
                                                        }
                                                    ?>
                                    ...
                                    <div class="tab-item <?php echo $formulario_active; ?>" data-tab-name="formulario" >
                                        <div class="white-section">
                                            <?php
                                                ...
                                                get_template_part('partials/formulario', 'charlas-colegio');
                                            ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
