<?php
    /*
    Template Name: Página Talleres vocacionales
    */
    ...
    if( isset( $_POST['st_nonce'] ) ){
        $sending_form_valid = send_talleres_form( $_POST );
    }
                    ...
                    <?php
                        if( $sending_form_valid === false ) :
                            ...
                            foreach( $ocultar_tabs as $ocultar ) :
                                if( $ocultar === 'fecha_talleres' ) {
                                    $fecha_talleres = 'ocultar';
                            ...
                            if( $contenido_principal === 'fecha_talleres' ) {
                    ...
                    ?>
                        ...
                        <div class="tabs-holder">
                            <div class="tabs-controls">
                                <?php if( empty($fecha_talleres) ) : ?>
                                    <button class="<?php echo $fechas_active; ?>" title="Ver pestaña" data-func="tabControl" data-target="informacion">Fechas de los talleres</button>
                                <?php endif; ?>
                            ...
                            <div class="tabs-box">
                                <div class="tab-item <?php echo $fechas_active; ?>" data-tab-name="informacion" >
                                    <div class="white-section">
                                        <?php echo  eventos("talleres-vocacionales")?>    
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-item <?php echo $formulario_active; ?>" data-tab-name="formulario" >
                                        <div class="white-section">
                                            <?php
                                                ...
                                                get_template_part('partials/formulario', 'talleres');
                                            ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
