...
<form class="regular-form" action="<?php echo get_permalink(); ?>#feedback" method="post" data-validation="generic" >
    ...
    <div class="parent form-set">
        ...
        <div class="grid-6 grid-mobile-4 no-gutter-left no-gutter-mobile">    
            ...
            <select class="regular-input select" id="ensayo" name="cotizacion-sede-ensayo" required data-role="dynamic-select" >
                <?php echo $idaCRM->selector_evento("talleres-vocacionales"); ?>
            </select>
        </div>
    </div>    
    <div class="parent form-set">
        <div class="grid-6 grid-mobile-4 no-gutter-left no-gutter-mobile">
            ...
            <input class="regular-input" type="text" id="rut" name="rut" maxlength="10" required placeholder="Ingresa tu RUT" data-custom-validation="validateRut">

            <label for="nombre" class="regular-label required">Nombres(s)</label>
            <input class="regular-input" type="text" id="nombre" name="nombre" maxlength="20" required placeholder="Ingresa tu nombre" data-custom-validation="onlyString">

            <label for="apellido-paterno" class="regular-label required">Apellido paterno</label>
            <input class="regular-input" type="text" id="apellido-paterno" name="apellido-paterno" maxlength="15" required placeholder="Ingresa tu apellido paterno" data-custom-validation="onlyString">

            <label for="apellido-materno" class="regular-label required">Apellido materno</label>
            <input class="regular-input" type="text" id="apellido-materno" name="apellido-materno" maxlength="15" required placeholder="Ingresa tu apellido materno" data-custom-validation="onlyString">
        </div>
        <div class="grid-6 grid-mobile-4 no-gutter-right no-gutter-mobile">
            <div class="input-group inline-group">
                ...
                <select class="regular-input select inline-input" id="celular-codigo" name="celular-codigo" required >
                    <option value="">--</option>
                    <option value="9">9</option>
                </select>

                <input class="regular-input inline-input" type="text" id="celular-numero" name="celular-numero" maxlength="8" required data-custom-validation="onlyNumbers">
            </div>

            <div class="input-group inline-group">
                <label for="telefono" class="regular-label required">Teléfono</label>
                <select class="regular-input select inline-input" id="telefono-codigo" name="telefono-codigo" required >
                    <option value="">--</option>
                    <?php
                ...
                <input class="regular-input inline-input" type="text" id="telefono-numero" name="telefono-numero" maxlength="8" required data-custom-validation="onlyNumbers">
            </div>
            ...
            <input class="regular-input" type="email" id="email-conf" name="email-confirm" required placeholder="Confirma tu email" data-custom-validation="equalToEmail" data-sample="email" data-func="preventPaste" data-events="paste">
        </div>
    </div>
