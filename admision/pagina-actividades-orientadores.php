<?php
    /*
    Template Name: Página Actividades para orientadores
    */
    ...
    if( isset( $_POST['st_nonce'] ) ){
        $sending_form_valid = send_orientadores_form( $_POST );
    }
                    ...
                    <?php
                        if( $sending_form_valid === false ) :
                            ...
                            foreach( $ocultar_tabs as $ocultar ) :
                                if( $ocultar === 'fecha_actividades' ) {
                                    $fecha_actividades = 'ocultar';
                            ...
                            if( $contenido_principal === 'fecha_actividades' ) {
                                $fechas_active = 'active';
                    ...
                    ?>
                        ...
                        <div class="tabs-holder">
                            <div class="tabs-controls">
                                <?php if( empty($fecha_actividades) ) : ?>
                                    <button class="<?php echo $fechas_active; ?>" title="Ver pestaña" data-func="tabControl" data-target="informacion">Fechas de actividades</button>
                                <?php endif; ?>
                            ...
                            <div class="tabs-box">
                                <div class="tab-item <?php echo $fechas_active; ?>" data-tab-name="informacion" >
                                    <div class="white-section">
                                                <?php echo  eventos("actividades-para-orientadores")?>    
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-item <?php echo $formulario_active; ?>" data-tab-name="formulario" >
                                        <div class="white-section">
                                            <?php
                                                ...
                                                get_template_part('partials/formulario', 'actividades-orientadores');
                                            ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
