<?php
    /*
    Template Name: Página Tomasino por un día
    */
    ...
    if( isset( $_POST['st_nonce'] ) ){
        $sending_form_valid = send_tomasino_form( $_POST );
    }
        ...
        <div class="container">
            <section class="page-body parent">
                ...
                <div class="grid-9 grid-smalltablet-12 no-gutter-right no-gutter-smalltablet">
                    ...
                    <?php   if( $sending_form_valid === false): ?>
                    <?php
                    ...
                    ?>
                        ...
                        <div class="tabs-holder">
                            <div class="tabs-controls">
                                <?php if( empty($fechas) ) : ?>
                                    <button class="active" title="Ver pestaña" data-func="tabControl" data-target="informacion">Fechas</button>
                                <?php endif; ?>
                            ...
                            <div class="tabs-box">
                                <div class="tab-item <?php echo $fechas_active; ?>" data-tab-name="informacion" >
                                    <div class="white-section">
                                        <?php echo  eventos("tomasino-por-un-dia")?>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-item <?php echo $formulario_active; ?>"  data-tab-name="formulario" >
                                        <div class="white-section">
                                            <?php
                                                ...
                                                get_template_part('partials/formulario', 'tomasino');
                                            ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
